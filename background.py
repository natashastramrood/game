...
class GroundBackground4():
    def __init__(self, WIDTH, HEIGHT):
        ...
        for x in range(0, self.width, self.stone_width):
            self.blocks.append(Tile(self.width-self.stone_width, x))
        for i in range(0, 10):
            self.blocks.append(Tile(self.stone_height*13, self.height-self.stone_height*(2+i)))
        self.blocks.append(Tile(self.stone_height*12, self.height-self.stone_height*8))
        for i in range(0, 8):
            self.blocks.append(Tile(self.stone_height*(13+i), self.height-self.stone_height*(11)))
        for i in range(0, 3):
            self.blocks.append(Tile(self.stone_height*(20),  self.height-self.stone_height*(11-i)))
        for i in range(0, 9):
            self.blocks.append(Tile(self.width - self.stone_width*i, self.height-self.stone_height*5))
        for i in range(0, 4):
            self.blocks.append(Tile(self.width - self.stone_width*8, self.height-self.stone_height*(5+i)))
        for i in range(0, 10):
            self.blocks.append(Tile(self.stone_width*i, self.height-self.stone_height*5))
        for i in range(0, 8):
            self.blocks.append(Tile(self.stone_width*9, self.height-self.stone_height*(5+i)))
        for i in range(0, 7):
            self.blocks.append(Tile(self.stone_width*i, self.height-self.stone_height*(12)))
        for i in range(0, 7):
            self.blocks.append(Tile(self.stone_width*3 + self.stone_width*i, self.height-self.stone_height*(9)))
        for i in range(0, 5):
            self.blocks.append(Tile(self.stone_width*4 +self.stone_width*i, self.height-self.stone_height*(6)))
...
class GroundBackground5():
    def __init__(self, WIDTH, HEIGHT):
        ...
        for x in range(0, self.stone_width*8, self.stone_width):
            self.blocks.append(Tile(x, self.height-self.stone_height))
            self.blocks.append(Tile(x, self.height-2*self.stone_height))
        for x in range(self.stone_width*20, self.width, self.stone_width):
            self.blocks.append(Tile(x, self.height-self.stone_height))
            self.blocks.append(Tile(x, self.height-2*self.stone_height))
        ...
        for i in range(0, 8):
            self.blocks.append(Tile(self.stone_height*(20), self.height- self.stone_height*(12-i)))
        for i in range(0, 10):
            self.blocks.append(Tile(self.stone_height*(17-i), self.height- self.stone_height*(9)))
        for i in range(0, 9):
            self.blocks.append(Tile(self.stone_height*(8), self.height- self.stone_height*(9-i)))
        for i in range(0, 10):
